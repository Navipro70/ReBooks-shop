...
export const books: Array<TBook> = [
    new Book("11/22/63", 1, 'https://images-na.ssl-images-amazon.com/images/I/81ks1SmtDnL.jpg',
        ...
        49th novel and the 42nd under his own name. The novel was announced on King's official site on March 2, 2011.[1]
        A short excerpt was released online on June 1, 2011,[2] and another excerpt was published in the October 28,
        2011, issue of Entertainment Weekly.[3] The novel was published on November 8, 2011[4] and quickly became a
        number-one bestseller. It stayed on The New York Times Best Seller list for 16 weeks.[5] 11/22/63 won the 
        2011 Los Angeles Times Book Prize for Best Mystery/Thriller and the 2012 International Thriller Writers Award 
        for Best Novel,[6][7] and was nominated for the 2012 British Fantasy Award for Best Novel[8] and the 2012 
        Locus Award for Best Science Fiction Novel.[9]The novel required considerable research to accurately portray
        the late 1950s and early 1960s.[10] King commented on the amount of research it required, saying "I've never
        tried to write anything like this before. It was really strange at first, like breaking in a new pair of shoes."[10]`),
    ...
    new Book("Carrie", 2, 'https://images-na.ssl-images-amazon.com/images/I/91P7rIp-ayL.jpg',
        ...
        copies.[1] Set primarily in the future year of 1979, it revolves around the eponymous Carrie White, an unpopular
        ...
        power to hurt and horrify." It is one of the most frequently banned books in United States schools.[2] Much
        ...
        television film, a 2013 feature film and a 2018 television special episode of Riverdale.[3] The book 
    ...
    new Book("Misery", 3, 'https://images-na.ssl-images-amazon.com/images/I/81VvBLFev9L.jpg',
        ...
        horror thriller novel written by Stephen King and first published by Viking Press on June 8, 1987.[1]
        ...
        the book's release.[2]Misery won the first Bram Stoker Award for Novel in 1987 and was nominated for
    ...
    new Book("It", 4, 'https://images-na.ssl-images-amazon.com/images/I/71lZgzNE2kL.jpg',
        ...
        writing it in 1981. He finished writing the book in 1985.[2] He also stated that he originally wanted the 
        ...
        received nominations for the Locus and World Fantasy Awards that same year.[3] Publishers Weekly listed It as 
        the best-selling hardcover fiction book in the United States in 1986.[4] It has been adapted into a 1990 two-part
